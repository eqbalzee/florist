            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="invoiceStatus.id.label" default="Id" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:formatDate date="${invoiceStatusInstance?.statusDate}" /></td>
