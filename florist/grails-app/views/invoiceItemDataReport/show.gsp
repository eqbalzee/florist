...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="invoiceItemDataReport.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: invoiceItemDataReportInstance, field: "id")}</td>
            ...
            <div class="buttons">
                <g:form>
                    <g:hiddenField name="id" value="${invoiceItemDataReportInstance?.id}" />
