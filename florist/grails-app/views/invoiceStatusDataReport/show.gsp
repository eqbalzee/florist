            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="invoiceStatusDataReport.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: invoiceStatusDataReportInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="invoiceStatusDataReport.invoice.label" default="Invoice" /></td>
                            
                            <td valign="top" class="value"><g:link controller="invoice" action="show" id="${invoiceStatusDataReportInstance?.invoice?.id}">${invoiceStatusDataReportInstance?.invoice?.id}</g:link></td>
