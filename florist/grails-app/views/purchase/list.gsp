                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="orderDate" title="${message(code: 'purchase.orderDate.label', default: 'Order Date')}" />
                    ...
                    <g:each in="${purchaseInstanceList}" status="i" var="purchaseInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: purchaseInstance, field: "orderDate")}</td>
